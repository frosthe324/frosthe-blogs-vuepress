...
<span class="line"></span>
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="自动更新通配符证书" tabindex="-1"><a class="header-anchor" href="#自动更新通配符证书"><span>自动更新通配符证书</span></a></h2><p>由于通配符证书仅支持 dns 方式的验证，而这种方式要求申请人在其域名管理后台添加新的 <code>TXT</code> 记录，除了某些官方列出的域名提供商以外，其他域名托管商(例如阿里云)的申请人需要外挂脚本来自动化这一过程，参考 <a href="https://certbot.eff.org/docs/using.html?highlight=wildcard#pre-and-post-validation-hooks" target="_blank" rel="noopener noreferrer">Pre and Post Validation Hooks</a>。</p><h2 id="使用-acme-sh-替代-certbot-acme-客户端-tbd" tabindex="-1"><a class="header-anchor" href="#使用-acme-sh-替代-certbot-acme-客户端-tbd"><span>使用 acme.sh 替代 certbot ACME 客户端(TBD)</span></a></h2>`,28)]))}const d=n(l,[["render",r]]),p=JSON.parse(`{"path":"/posts/security/security-cert-wildcard-from-letsencrypt/security-cert-wildcard-from-letsencrypt.html","title":"向 Let's Encrypt CA 申请通配符证书","lang":"zh-CN","frontmatter":{"title":"向 Let's Encrypt CA 申请通配符证书","description":"申请通配符数字证书是 Let's Encrypt 近期推出的功能，只有支持 ACME v2 协议的客户代理软件才能申请通配符证书","excerpt":"申请通配符数字证书是 Let's Encrypt 近期推出的功能，只有支持 ACME v2 协议的客户代理软件才能申请通配符证书","author":"Frost He","date":"2018-07-24T00:00:00.000Z","lang":"zh-CN","category":["Cryptography"],"tag":["security","https"]},"git":{"updatedTime":1772892199000,"contributors":[{"name":"Frost He","username":"","email":"frosthe@qq.com","commits":3}],"changelog":[{"hash":"9084b9be2b5259bd761dea3af5664f5e729d3efb","time":1772892199000,"email":"frosthe@qq.com","author":"Frost He","message":"修复了 build 错误"},{"hash":"ffa4807bd7d8fdbc3c457d61dcbe1be8e2744be4","time":1772706409000,"email":"frosthe@qq.com","author":"Frost He","message":"博客迁移初步完成"},{"hash":"a425f2611bfe3a002f92d9122c0c1114220b00ca","time":1768991112000,"email":"frosthe@qq.com","author":"Frost He","message":"migration WIP"}]},"filePathRelative":"posts/security/security-cert-wildcard-from-letsencrypt/security-cert-wildcard-from-letsencrypt.md"}`);export{d as comp,p as data};
